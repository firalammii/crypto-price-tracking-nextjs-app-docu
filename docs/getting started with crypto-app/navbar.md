...
1. a place for logo and App Name
2. currency type selection dropdown 
3. dark mode vs light mode toggler button
3. refresh button for manually fetching new currency data
